...
#define PIN_TOP_CLK 16
#define PIN_TOP_DIO 17

#define PIN_BOT_CLK 19
#define PIN_BOT_DIO 20

#define PIN_ENC_BUT 6		// Button pin for the encoder when pressed
#define PIN_ENC_CLK 8		// "Clock" pin for the encoder, really just one phase
